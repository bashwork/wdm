...
//
//import org.school.core.{ItemSet,AbstractSupport}
//
///**
// */
//object XmlFormat extends AbstractFormat {
//
//    /**
...
//     */
//    def process(source:Iterator[String], lookup:AbstractSupport) : List[ItemSet] = {
